...
export const PROJECTS = [
  {
    title: 'Athena',
    text: 'An AI built from scratch to be the spokesperson for my club — my first true step into applied LLMs, and the build that changed how I see software.',
    tags: ['ai', 'llm', 'from scratch'],
  },
  {
    title: 'The Twenty',
    text: 'Twenty-plus websites for work, fun and my club — fragments of practice, each one sharper than the last.',
    tags: ['web', 'client work', 'club'],
  },
  {
    title: 'Elysiaa',
